...
if __name__ == "__main__":
    ...
    dl_test = DataLoader(ds_test, batch_size=BATCH_SIZE, shuffle=SHUFFLE, num_workers=NUM_WORKERS,
                         persistent_workers=True, pin_memory=True)

    SRC_SIZE = len(FEATURES)
    autoencoder = Autoencoder(SRC_SIZE, SRC_SIZE - 2, SRC_SIZE - 4)
    ...
    trainer = Trainer(max_epochs=EPOCHS, enable_progress_bar=True,
                      ...
                      check_val_every_n_epoch=10)  # , accumulate_grad_batches=3
